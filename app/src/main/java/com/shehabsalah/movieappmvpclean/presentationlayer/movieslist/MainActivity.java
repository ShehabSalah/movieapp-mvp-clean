...
import com.shehabsalah.movieappmvpclean.util.ActivityUtils;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(id == R.id.action_popular){
            moviesFragment.setType(MoviesSortType.MOST_POPULAR, true, true);
        }else if (id == R.id.action_top_rated){
            moviesFragment.setType(MoviesSortType.TOP_RATED, true, true);
        }else if (id == R.id.action_favorite){
            moviesFragment.setType(MoviesSortType.FAVORITES, true, true);
        }
